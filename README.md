...
A.1) Cloptime'ı sunucusuna ekleyen herkes bu politikaları kabul etmiş sayılır..
```
```
...
A.1) Anyone who adds Cloptime to their server is deemed to have accepted these policies.
```
```
...
```
```
Cloptime reserves the right to change and edit these articles. 
```
